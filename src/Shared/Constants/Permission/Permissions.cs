...
namespace FPAAgentura.Shared.Constants.Permission;
...
public static class Permissions
    {
        public static class Businesses
        {
            ...
            public const string Export = "Permissions.Businesses.Export";
            public const string Search = "Permissions.Businesses.Search";
        }
